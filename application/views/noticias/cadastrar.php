...
<div class="content mt-3">
    <div class="row">
        <div class="col-md-12 card">
            <form action="<?= base_url('/noticias/salvar')?>" method="post" enctype="multipart/form-data">
                <div class="row justify-content-end">
                    ...
                    <div class="col-md-12">
                        ...
                        <label for="imagem" class="input-file">
                            <i class="fa fa-image" style="margin-right: 5px;"></i>Cadastrar Imagem
                        </label>
                    </div>


                    <div class="col-md-12 top">
                        <textarea name="texto" id="texto"  class="form-control" rows="30" required></textarea>
                    </div>
